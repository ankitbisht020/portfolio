            ...
            <div className="py-16 lg:py-48 flex flex-col-reverse lg:flex-row justify-around gap-10 lg:gap-0">
                ...
                <div className="relative mx-auto lg:mx-0 mt-12 md:mt-16 lg:mt-0">
                    ...
                    {techStackImages.map((image, index) => (
                        <div key={index} className={`absolute grid ${index === 0 ? '-top-6 -left-12' : index === 1 ? 'top-0 -right-12' : index === 2 ? 'bottom-[4rem] -right-16' : 'bottom-10 -right-8'} w-16 h-16 md:w-20 md:h-20 bg-white dark:bg-grey-800 rounded-full place-items-center hover:shadow-lg transition-shadow`}>
                            <Image alt='tech-stack' className="h-8 w-8 md:h-10 md:w-10 object-cover" src={image} width={100} height={100} />
                        </div>
                    ))}
                </div>
